...
import { GraphsPanel } from "@/components/gtd/GraphsPanel";
import { useGtdReview } from "@/hooks/useGtd";

type Tab = "capture" | "clarify" | "organize" | "review" | "engage" | "graphs";
...
const TABS: { id: Tab; step: number; label: string; hint: string }[] = [
  ...
  { id: "graphs", step: 6, label: "Графы", hint: "Графы по приоритету" },
];
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link href="/gtd/feed" className="btn-primary">
            <Film size={16} /> Лента дел
          </Link>
          <Link href="/gtd/graph/root" className="btn-ghost">
