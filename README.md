...
| **Интервальное голодание** | Протоколы 14:10 / 16:8 / 18:6 / 20:4 / OMAD или своё окно; живой «круг часов» с обратным отсчётом до конца голодания или окна еды и процентом заполнения; лог постов, рекорд и среднее. **Ежедневное расписание**: автостарт голодания в заданный час и Web Push‑уведомления о старте и каждый час с остатком времени (проверяет воркер раз в минуту, безопасно при нескольких репликах); блок на дашборде |
...
| GET/PUT/POST | `/fasting` · `/fasting/settings` · `/fasting/schedule` · `/fasting/start` · `/fasting/stop` · `/fasting/active` · `/fasting/history` | Интервальное голодание: состояние с «кругом», протокол, ежедневное расписание + уведомления, старт/стоп, история |
